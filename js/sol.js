        ...
        defaults: {
            ...
            events: {
                ...
                onScroll: function () {
                    ...
                    this.$selectionContainer.css('width', selectionContainerWidth);
...
function change_option(action){
    if(action=='selectall'){
        jQuery("input[class='tadarab-selectall']").val('all');
    }
    if(action=='deselectall') {
        jQuery("input[class='tadarab-selectall']").val('no');
    }
    if(action=='deselect') {
        jQuery("input[class='tadarab-selectall']").val('no');
    }
