...
<style>
	li.cld-day.currMonth {cursor: pointer;}	
	.advance_cal #jacro-event-caleandar ul.cld-days a {padding: 5px !important;margin: 0px 0px 3px 0px !important;line-height: 16px;font-size: 12px !important;text-decoration: none;color: #fff;border-radius: 4px;}
	.advance_cal #jacro-event-caleandar ul.cld-days .today a {border-bottom: 2px solid #fff;border-radius: 0;color: #fff;display: block;}
	.basic_cal #jacro-event-caleandar ul.cld-days a {padding: 0px !important;border-radius: 50%;margin: 0px !important;font-size: 0;position: absolute;height: 14px;width: 15px;top: 28px;}
	ul.cld-days li.cld-day::-webkit-scrollbar {width: 0.4em;}
	ul.cld-days li.cld-day::-webkit-scrollbar-track {box-shadow: inset 0 0 3px rgba(0, 0, 0, 0.4);}
	ul.cld-days li.cld-day::-webkit-scrollbar-thumb {background-color: darkgrey;outline: 1px solid slategrey;}
	@media (max-width:767px){
		.advance_cal #jacro-event-caleandar .cld-main ul.cld-days li.cld-day {width: 25%;text-align: center;font-size: 18px;padding: 10px;}
	}
...
<div class="row jacro-container">
	<div class="row jacro-events">
		<div class="col-md-12 col-sm-12 col-xs-12">
            <div class="col-md-12 .col-md-push-12 advance_cal col-sm-12 col-xs-12 film_single">
				<div id="jacro-event-caleandar"></div> 
			</div>
			<div class="col-md-12 .col-md-pull-12 col-sm-12 col-xs-12 jacro-events calendartypelarge" id="jacro-calender-events">
                                            ...
                                            <div class="film-title jacro-text-left" style="margin: 0px !important;">
                                                <h3>
	                                                <strong><a style="color: #101010;" href="<?php echo esc_url($url); ?>" target=""><?php echo esc_html($film['filmtitle']); ?></a></strong>
	                                                 <span style="float: right; font-size: 13px; font-weight: bold; line-height: 33px; display: inline-block; width: 33px; height: 33px; margin-left: 5px; text-align: center; letter-spacing: 0; color: #fff; border-radius: 50%; background: #4a4a4a;">
	                                                    <?php echo $certificate; ?></span>
                                                </h3>
                                            </div>
